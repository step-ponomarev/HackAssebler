...
public final class TokenPatterns {
    ...
    static Pattern C_INSTRUCTION = Pattern.compile(String.format("(%s|%s)", ASSIGN_INSTRUCTION.pattern().substring(1, ASSIGN_INSTRUCTION.pattern().length() - 1), JMP_INSTRUCTION.pattern().substring(1, JMP_INSTRUCTION.pattern().length() - 1)));
